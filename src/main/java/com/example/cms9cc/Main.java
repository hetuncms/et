...
public class Main {
    ...
    @PostMapping("/index")
    public HashMap<String, Object> index(@RequestHeader Map<String, String> header, @RequestBody String reqBody) {
        ...
        HashMap<String, Object> allConfig = adminService.getAllConfig();
        HashMap<String, Object> result = new HashMap<>();
        result.put("config", allConfig);
        result.put("liveitem", liveItem);
        return result;
    }
